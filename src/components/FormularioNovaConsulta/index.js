...
const FormularioNovaConsulta = ({ fetchData }) => {
	const { register, handleSubmit, reset, resetField, watch } = useForm({});
	...
	const onSubmit = async (data) => {
		try {
			//console.log(data.diaSelecionado, data.horarioSelecionado);
